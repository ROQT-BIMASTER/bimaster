  ...
  return (
    <ChinaPageShell>
      ...
      />
        ...
        {/* Approval Panel Button — somente usuários Brasil */}
        {isBrasilUser && (
          <Card className="p-4">
        ...
        {painelAprovacaoOpen && isBrasilUser && (
        ...
        {/* Pasta Digital removida — agora vive em Vincular China */}
        ...
        {/* Processo Unificado do Produto — bloco interno, oculto do usuário final */}
