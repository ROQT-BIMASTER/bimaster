...
import { VendasSyncPanel } from '@/components/financeiro/VendasSyncPanel';
...
export default function VendasSyncPage() {
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Vendas / Faturamento — Engine direta SQL Server (ConsultaPowerBI)
          </p>
        </div>
