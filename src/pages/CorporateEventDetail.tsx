...
import { useCorporateEvents, useCorporateEventById } from "@/hooks/useCorporateEvents";
...
export default function CorporateEventDetail() {
  ...
  const { updateEvent } = useCorporateEvents();
  const { data: event, isLoading } = useCorporateEventById(id!);
