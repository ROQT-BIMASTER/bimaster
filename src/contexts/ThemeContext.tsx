...
export type ThemeKey = "navy-blue" | "midnight-dark" | "slate-professional" | "sage-green" | "bordeaux" | "rose-gold";
...
function applyTheme(theme: ThemeDefinition) {
  ...
  root.style.setProperty("--sidebar-accent-foreground", "220 14% 96%");
