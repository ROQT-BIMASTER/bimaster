...
export function HeaderResultados({ ano, onAnoChange, anos }: Props) {
  return (
    <>
      <FuturaBackButton />
      <header className="mt-6 mb-8 flex items-end justify-between flex-wrap gap-6 border-b border-rv-linha pb-8">
        <div>
          ...
          <p className="mt-3 text-sm text-rv-text-suave max-w-xl">
            Panorama editorial das vendas faturadas — ranking por vendedor, valor e recorrência
            de clientes, evolução mensal comparada ao ano anterior e distribuição por tabela de preço.
          </p>
        </div>
        ...
        <div className="flex items-stretch gap-3">
          ...
          >
            ...
            <span className="font-medium">Futura</span>
