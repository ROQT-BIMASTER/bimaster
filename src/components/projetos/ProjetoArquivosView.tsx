...
import { detectFileKind, type FileKind } from "@/lib/utils/detectFileKind";

/** @deprecated use detectFileKind from @/lib/utils/detectFileKind */
export const detectKind = detectFileKind;

function getFileIcon(kind: FileKind, className = "h-5 w-5") {
