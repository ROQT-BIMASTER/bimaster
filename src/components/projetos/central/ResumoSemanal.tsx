        ...
        <div>
          ...
          <div className="h-[140px]">
            {data.sparkline.every((d) => d.atual === 0 && d.anterior === 0) ? (
              <div className="h-full w-full flex items-center justify-center rounded-md border border-dashed border-border/50 bg-muted/20">
                <p className="text-xs text-muted-foreground">Sem conclusões registradas no período</p>
              </div>
            ) : (
