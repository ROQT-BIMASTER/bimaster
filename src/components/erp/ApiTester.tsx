...
const PRESET_ENDPOINTS = [
  ...
  { label: "Contas a Pagar — Parcelas", method: "GET" as HttpMethod, path: "/contas-pagar-api/parcelas?conta_pagar_id=" },
  { label: "Contas a Pagar — Pagamentos", method: "GET" as HttpMethod, path: "/contas-pagar-api/pagamentos?conta_pagar_id=" },
  { label: "Contas a Pagar — Anexos", method: "GET" as HttpMethod, path: "/contas-pagar-api/anexos?conta_pagar_id=" },
