...
import {
  ...
  AlertTriangle, Banknote, Calendar, Activity,
  Server, Play, Timer
} from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Engine direta SQL Server → Banco de dados
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-sm font-medium flex items-center gap-2"><Banknote className="h-4 w-4 text-orange-500" />Total a Pagar</CardTitle></CardHeader>
          <CardContent>
            <p className="text-2xl font-bold text-orange-600">{formatCurrency(stats?.totalValorAberto || 0)}</p>
          </CardContent>
        </Card>
        <Card>
