...
export function EditarMateriaPrimaDialog({
  open,
  onOpenChange,
  materiaPrima,
  onSuccess,
}: EditarMateriaPrimaDialogProps) {
  ...
  useEffect(() => {
    if (open && materiaPrima) {
      ...
      setFormData({
        ...
        categoria_id: materiaPrima.categoria_id || "",
        fornecedor_id: materiaPrima.fornecedor_id || "",
        ...
        data_validade: materiaPrima.data_validade || "",
