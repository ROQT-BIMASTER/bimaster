    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between gap-2 text-xs">
        <div className="flex items-center gap-1.5 text-muted-foreground min-w-0">
          ...
          <span className="truncate">conclusões nos últimos {windowDays} dias</span>
          {fallbackCount > 0 && (
            <span
            ...
            <UITooltip>
              ...
              <TooltipContent side="left" className="max-w-[260px] text-xs space-y-1">
                <p>
                  ...
                  A janela é configurável (7, 14 ou 30 dias corridos).
                </p>
      ...
      {total === 0 ? (
        <div className="flex flex-col items-center justify-center text-center py-8 px-4 rounded-md border border-dashed border-border/60 bg-muted/20">
          ...
          <p className="text-xs font-medium text-foreground">
            Sem conclusões registradas nos últimos {windowDays} dias
          </p>
