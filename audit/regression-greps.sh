...
check      "parcela-handlers onConflict conta_pagar_id,numero_parcela" "$(grep -cE \"onConflict:\\s*'conta_pagar_id,numero_parcela'\" supabase/functions/_shared/contas-pagar/parcela-handlers.ts)" 1
