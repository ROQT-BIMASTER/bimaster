...
Deno.serve(secureHandler({ auth: "none", rateLimit: 60, rateLimitPrefix: "finalidades-transferencia-api" }, async (req) => {
  ...
  try {
    ...
    logger.error("❌ finalidades-transferencia-api error:", e);
