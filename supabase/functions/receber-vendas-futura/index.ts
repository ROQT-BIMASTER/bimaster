...
const ItemSchema = z.object({
  ...
  cfop_codigo: z.number().int().optional().nullable(),
  ncm: z.string().optional().nullable(),
  cst_icms: z.string().optional().nullable(),
  csosn: z.string().optional().nullable(),
  icms_base: z.number().optional().nullable(),
  icms_aliquota: z.number().optional().nullable(),
  icms_valor: z.number().optional().nullable(),
  st_base: z.number().optional().nullable(),
  st_valor: z.number().optional().nullable(),
  ipi_cst: z.string().optional().nullable(),
  ipi_base: z.number().optional().nullable(),
  ipi_aliquota: z.number().optional().nullable(),
  ipi_valor: z.number().optional().nullable(),
  pis_cst: z.string().optional().nullable(),
  pis_base: z.number().optional().nullable(),
  pis_aliquota: z.number().optional().nullable(),
  pis_valor: z.number().optional().nullable(),
  cofins_cst: z.string().optional().nullable(),
  cofins_base: z.number().optional().nullable(),
  cofins_aliquota: z.number().optional().nullable(),
  cofins_valor: z.number().optional().nullable(),
  tributos_valor: z.number().optional().nullable(),
}).strict();
...
const VendaSchema = z.object({
  ...
  cliente_uf: z.string().max(2).optional().nullable(),
  ...
  cfop_codigo: z.number().int().optional().nullable(),
  total_icms_base: z.number().optional().nullable(),
  total_icms_valor: z.number().optional().nullable(),
  total_ipi_base: z.number().optional().nullable(),
  total_ipi_valor: z.number().optional().nullable(),
  total_st_base: z.number().optional().nullable(),
  total_st_valor: z.number().optional().nullable(),
  total_tributos_valor: z.number().optional().nullable(),
    ...
    try {
      ...
      const notaRows = vendas.map((v) => {
        ...
        return {
          ...
          cfop_codigo: v.cfop_codigo ?? null,
          total_icms_base: v.total_icms_base ?? null,
          total_icms_valor: v.total_icms_valor ?? null,
          total_ipi_base: v.total_ipi_base ?? null,
          total_ipi_valor: v.total_ipi_valor ?? null,
          total_st_base: v.total_st_base ?? null,
          total_st_valor: v.total_st_valor ?? null,
          total_tributos_valor: v.total_tributos_valor ?? null,
      ...
      const itemRows = vendas.flatMap((v) =>
        v.itens.map((it) => ({
          ...
          cfop_codigo: it.cfop_codigo ?? null,
          ncm: it.ncm ?? null,
          cst_icms: it.cst_icms ?? null,
          csosn: it.csosn ?? null,
          icms_base: it.icms_base ?? null,
          icms_aliquota: it.icms_aliquota ?? null,
          icms_valor: it.icms_valor ?? null,
          st_base: it.st_base ?? null,
          st_valor: it.st_valor ?? null,
          ipi_cst: it.ipi_cst ?? null,
          ipi_base: it.ipi_base ?? null,
          ipi_aliquota: it.ipi_aliquota ?? null,
          ipi_valor: it.ipi_valor ?? null,
          pis_cst: it.pis_cst ?? null,
          pis_base: it.pis_base ?? null,
          pis_aliquota: it.pis_aliquota ?? null,
          pis_valor: it.pis_valor ?? null,
          cofins_cst: it.cofins_cst ?? null,
          cofins_base: it.cofins_base ?? null,
          cofins_aliquota: it.cofins_aliquota ?? null,
          cofins_valor: it.cofins_valor ?? null,
          tributos_valor: it.tributos_valor ?? null,
