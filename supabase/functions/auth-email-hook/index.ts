...
const EMAIL_SUBJECTS: Record<string, string> = {
  ...
  invite: 'Você foi convidado — Huggs',
  magiclink: 'Seu link de acesso — Huggs',
  recovery: 'Redefinir sua senha — Huggs',
  email_change: 'Confirme a alteração de e-mail — Huggs',
  reauthentication: 'Seu código de verificação — Huggs',
}
...
const SENDER_DOMAIN = "notify.bimaster.online"
const ROOT_DOMAIN = "bimaster.online"
const FROM_DOMAIN = "bimaster.online" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://bimaster.lovable.app"
