        ...
        blocks: {
          ...
          items: {
            oneOf: [
              ...
              { type: "object", properties: { kind: { const: "kpis" }, items: { type: "array", maxItems: 8, items: { type: "object", properties: { label: { type: "string" }, value: {}, hint: { type: "string" } }, required: ["label", "value"], additionalProperties: false } } }, required: ["kind", "items"], additionalProperties: false },
