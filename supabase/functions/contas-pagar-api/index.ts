...
// v2.4.1 redeploy bump: repuxa IncluirSchema/UpsertSchema com departamento_id/plano_contas_id/natureza_lancamento (edge estava servindo bundle stale que rejeitava departamento_id).
