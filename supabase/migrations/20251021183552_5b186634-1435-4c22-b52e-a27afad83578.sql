...
CREATE INDEX idx_etl_changelog_table ON etl_changelog(table_name);
CREATE INDEX idx_etl_changelog_date ON etl_changelog(changed_at);
CREATE INDEX idx_etl_changelog_record ON etl_changelog(record_id);
...
CREATE INDEX idx_agg_daily_kpis_date ON agg_daily_kpis(date);
CREATE INDEX idx_agg_daily_kpis_regiao ON agg_daily_kpis(regiao);
CREATE INDEX idx_agg_daily_kpis_uf ON agg_daily_kpis(uf);
