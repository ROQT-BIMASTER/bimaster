...
DROP TRIGGER IF EXISTS after_visit_complete ON visits CASCADE;
DROP TRIGGER IF EXISTS after_audit_approval ON gondola_audits CASCADE;
DROP TRIGGER IF EXISTS after_photo_upload ON photos CASCADE;
DROP TRIGGER IF EXISTS after_shelf_measurement ON shelf_measurements CASCADE;
