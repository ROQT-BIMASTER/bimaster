...
CREATE TABLE IF NOT EXISTS public.erp_contas_pagar_rubysp (
...
GRANT SELECT ON public.erp_contas_pagar_rubysp TO authenticated;
GRANT ALL    ON public.erp_contas_pagar_rubysp TO service_role;

ALTER TABLE public.erp_contas_pagar_rubysp ENABLE ROW LEVEL SECURITY;
