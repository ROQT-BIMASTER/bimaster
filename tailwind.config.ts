  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        subtask: {
          DEFAULT: "hsl(var(--subtask))",
          hover: "hsl(var(--subtask-hover))",
        },
        sidebar: {
      ...
      boxShadow: {
        'soft': '0 2px 8px -2px hsla(222, 47%, 11%, 0.08)',
        'soft-lg': '0 8px 24px -4px hsla(222, 47%, 11%, 0.12)',
        'glow': '0 0 20px hsla(221, 83%, 53%, 0.25)',
        'glow-lg': '0 0 40px hsla(221, 83%, 53%, 0.3)',
